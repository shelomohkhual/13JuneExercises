...
describe "Startup" do
  let(:startup_1) do
    ...
    Startup.new("PowerDev Girls", 22000, salaries)
  end
  ...
  let(:startup_2) do
    ...
    Startup.new("Dexter's Airatory", 30000, salaries)
  end
  ...
  describe "#initialize" do
    ...
    it "should set @name, @funding, and @salaries with their respective args" do
      expect(startup_1.instance_variable_get(:@name)).to eq("PowerDev Girls")
  ...
  describe "#hire" do
    it "should take in a employee_name (string) and title (string)" do
      startup_1.hire("Mojojojo", "CEO")
    end

    context "when the title is invalid" do
      it "should raise an error" do
        expect { startup_1.hire("Mojojojo", "Designer") }.to raise_error
      end
    ...
    context "when the title is valid" do
      it "should create a new Employee with the given args" do
        expect(Employee).to receive(:new).with("Mojojojo", "CEO")
        startup_1.hire("Mojojojo", "CEO")
      end
      ...
      it "should add the new Employee instance to @employees" do
        ...
        expect(employee).to have_attributes(name: "Mojojojo", title: "CEO")
      end
    end
  end
  ...
  describe "#pay_employee" do
    it "should accept an Employee instance as an arg" do
      startup_1.pay_employee(Employee.new("Mojojojo", "CEO"))
    end
    ...
    context "when the startup has enough funding to pay the employee" do
      it "should call Employee#pay with the salary that corresponds with their title" do
        employee = Employee.new("Mojojojo", "CEO")
  ...
  describe "#payday" do
    it "should call #pay_employee for each employee" do
      startup_1.hire("Mojojojo", "CEO")
      startup_1.hire("Blossom", "CTO")
      startup_1.hire("Bubbles", "Software Engineer")
      startup_1.hire("Buttercup", "Software Engineer")
  ...
  describe "#acquire" do
    ...
    it "should add the given startup's employees to our @employees" do
      startup_1.hire("Mojojojo", "CEO")
      startup_2.hire("Dexter", "CEO")
      startup_2.hire("DeeDee", "Pilot")
